...
import buildingCam from '../Img/buildingCam.jpg';
import businessCentral from '../Img/businessCentral.jpg';
...
function Home() {
  ...
  const slides = [buildingCam, businessCentral, yetoo];
          ...
          <div className="slides-box">
            ...
            <div className="slide-list">
              {slides.map((slide, index) => (
                  <div key={index} className={`slide-item-${index + 1}`}
                       style={{display: index === currentSlide ? 'block' : 'none'}}>
                    <img src={slide} alt={`Slide ${index + 1}`} style={{width: '50%', height: 'auto'}}/>
                  </div>
              ))}
            </div>
          </div>
          <div className="slides-navigation">
            <div className="click-area" onClick={prevSlide}>
              <img src={fg} alt="Previous" className="arrow"/>
            </div>
            <div className="click-area" onClick={nextSlide}>
              <img src={fd} alt="Next" className="arrow"/>
            </div>
          </div>
        </div>
        <br/><br/>
...
export default Home;
        ...
        <div className="yetoo-part2">
          <div className="yetoo-paragra">
            <div className="yetoo-text-1">
              <br/><br/><br/><br/>
              Enhanced auditing and disaster recovery
            </div>
            <br/>
            <div className="yetoo-text-2">
              Retain complete control over your repository's files and folders. Detect unauthorized access or edits
              to reports through comprehensive logs and thorough activity monitoring. Additionally, easily recover any
              accidentally deleted patient information for added peace of mind.
            </div>
          </div>
          <div className="yetoo-illu">
            <div className="Rectangle568">
              <img className="yetoo-image" src={yetooillu} alt={"yetoo illu"}/>
            </div>
          </div>
        </div>
        */