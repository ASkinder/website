...
import yetoo from '../Img/yetoo_illu.jpg';
    ...
    <div className="Home">
        ...
        <div className="slides-box">
          ...
          <div className="slide-list">
            {slides.map((slide, index) => (
              <div key={index} className={`slide-item-${index + 1}`} style={{ display: index === currentSlide ? 'block' : 'none' }}>
      ...
      <div className="container">
        <div className="rectangles">
          ...
          <div className="rectangle-138">
            <br />
            <div className="financial-it-consultant">Financial & IT Consultant</div><br />
            <div className="financial">"Financial analysis involves interpreting financial data to evaluate a company's performance and make informed decisions. This includes assessing financial statements, ratios, and metrics to gauge profitability, liquidity, and overall financial health."</div>
          </div>
        </div>
